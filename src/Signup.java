        ...
        if (customer) {
            ...
            try {
                ...
                if (edtUsername.getText().length() > 0 && edtPassword.getText().length() > 0) {
                    if (Login.customersAcc.get(edtUsername.getText()) != null
                            && edtPassword.getText().equals(Login.customersAcc.get(edtUsername.getText()))) {
                        JOptionPane.showMessageDialog(this, "Account is already in the database!");
                    } else {
                        stm.executeUpdate("insert into customers values ('" + edtUsername.getText() + "', '" + edtPassword.getText() + "')");
            ...
            try {
                ...
                if (edtUsername.getText().length() > 0 && edtPassword.getText().length() > 0) {
                    if (Login.employeesAcc.get(edtUsername.getText()) != null
                            && edtPassword.getText().equals(Login.employeesAcc.get(edtUsername.getText()))) {
                        JOptionPane.showMessageDialog(this, "Account is already in the database!");
                    } else {
...
// mysql connection
            ...
            try {
                ...
                if (edtUsername.getText().length() > 0 && edtPassword.getText().length() > 0) {
                    if (Login.managersAcc.get(edtUsername.getText()) != null
                            && edtPassword.getText().equals(Login.managersAcc.get(edtUsername.getText()))) {
                        JOptionPane.showMessageDialog(this, "Account is already in the database!");
                    } else {
                        stm.executeUpdate("insert into managers values ('" + edtUsername.getText() + "', '" + edtPassword.getText() + "')");
                        JOptionPane.showMessageDialog(this, "Account is added to the database!");
                        resetChoice();
                        Login login = new Login();
                        login.setVisible(true);
    ...
    private void initComponents() {
        ...
        jPanel4Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(jLabel3)
                    .addComponent(edtPassword, javax.swing.GroupLayout.DEFAULT_SIZE, 30, Short.MAX_VALUE))
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        resetChoice();
        SignupOption so = new SignupOption();
        so.setVisible(true);
        dispose();
