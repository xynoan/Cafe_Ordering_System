 ...
 * @author admin
 */
public class ManageManagerCode extends javax.swing.JFrame {

    /**
     * Creates new form Feedback
     */
    public ManageManagerCode() {
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            stm.executeUpdate("update code set `manager`="+"'"+jPasswordField1.getText()+"'");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ManageManagerCode().setVisible(true);
            }
        });
    }
